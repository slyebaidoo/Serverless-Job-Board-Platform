...
module "cors" {
  ...
  version = "0.3.3"
  api_id          = aws_api_gateway_rest_api.job_apigw.id
  api_resource_id = aws_api_gateway_resource.job.id
  allow_origin = "*"
...
resource "aws_api_gateway_method" "createjobget" {
  rest_api_id   = aws_api_gateway_rest_api.job_apigw.id
  resource_id   = aws_api_gateway_resource.job.id
  http_method   = "GET"
  authorization = "NONE"
...
resource "aws_api_gateway_integration" "createjobget-lambda" {

  rest_api_id = aws_api_gateway_rest_api.job_apigw.id
  resource_id = aws_api_gateway_method.createjobget.resource_id
  http_method = aws_api_gateway_method.createjobget.http_method
